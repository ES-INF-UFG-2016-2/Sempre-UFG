...
(
  ...
  codigo_area int(10) not null,
  area_conhecimento_nome varchar(100) null,
  area_conhecimento_codigo int(10) null,
...
(
  ...
  tipo_resolucao ENUM ('CEPEC', 'CONSUNI') not null,
  ...
  area_conhecimento_codigo int(10) not null,
...
(
  ...
  tipo_instituicao ENUM('Federal', 'Estadual', 'Municipal', 'Particular') not null,
  area_conhecimento_nome varchar(100) null,
  area_conhecimento_codigo int(10) null,  
  primary key (nome_curso),
  constraint fk_area_conhecimento_curso_outra_ies foreign key (area_conhecimento_nome, area_conhecimento_codigo) references area_conhecimento(nome_area, codigo_area)
