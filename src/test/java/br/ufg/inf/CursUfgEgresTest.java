...
public class CursUfgEgresTest {
    ...
    public void testaCreateTableAreaDeConhecimento() {
        ...
        String sql = "CREATE TABLE AREA_DE_CONHECIMENTO " +
            ...
            "CHECK (AREA_DE_CONHECIMENTO.CODIGO > 0)," +
            "SUPER_AREA INTEGER REFERENCES AREA_DE_CONHECIMENTO (CODIGO)," +
            "CHECK (AREA_DE_CONHECIMENTO.SUPER_AREA > 0));";
    ...
    public void testaCreateTableCursoUFG() {
        String sql = "CREATE TABLE CURSO_DA_UFG" +
            ...
            "AREA_DE_CONHECIMENTO INTEGER NOT NULL REFERENCES AREA_DE_CONHECIMENTO (CODIGO)," +
            "CHECK (CURSO_DA_UFG.NUMERO_DA_RESOLUCAO > 0 AND CURSO_DA_UFG.AREA_DE_CONHECIMENTO > 0));";
    ...
    public void testaCreateTableHistoricoUFG() {
        String sql = "CREATE TABLE HISTORICO_NA_UFG" +
            ...
            "CURSO INTEGER NOT NULL REFERENCES CURSO_DA_UFG (NUMERO_DA_RESOLUCAO)," +
            "CHECK (HISTORICO_NA_UFG.NUMERO_MATRICULA_CURSO > 0)," +
            "CHECK (HISTORICO_NA_UFG.MES_DE_INICIO > 0 AND HISTORICO_NA_UFG.MES_DE_INICIO < 13)," +
            "CHECK (HISTORICO_NA_UFG.ANO_DE_INICIO > 1959)," +
            "CHECK (HISTORICO_NA_UFG.MES_DE_FIM > 0 AND HISTORICO_NA_UFG.MES_DE_FIM < 13)," +
            "CHECK (HISTORICO_NA_UFG.CURSO > 0)," +
    ...
    public void testaCreateAvaliacaoCursoPeloEgresso() {
        String sql = "CREATE TABLE AVALIACAO_DO_CURSO_PELO_EGRESSO" +
            "(HISTORICO INTEGER NOT NULL REFERENCES HISTORICO_NA_UFG (NUMERO_MATRICULA_CURSO)," +
            ...
            "CHECK (AVALIACAO_DO_CURSO_PELO_EGRESSO.SATISFACAO_CURSO >= 0 AND AVALIACAO_DO_CURSO_PELO_EGRESSO.SATISFACAO_CURSO <=10)," +
            "CONCEITO_GLOBAL_CURSO INTEGER NOT NULL," +
            "CHECK (AVALIACAO_DO_CURSO_PELO_EGRESSO.CONCEITO_GLOBAL_CURSO >= 0 AND AVALIACAO_DO_CURSO_PELO_EGRESSO.CONCEITO_GLOBAL_CURSO <=10)," +
            "PREPARACAO_PARA_MERCADO INTEGER NOT NULL," +
            "CHECK (AVALIACAO_DO_CURSO_PELO_EGRESSO.PREPARACAO_PARA_MERCADO >= 0 AND AVALIACAO_DO_CURSO_PELO_EGRESSO.PREPARACAO_PARA_MERCADO <=10)," +
            "MELHORIA_CAPACIDADE_COMUNICACAO INTEGER NOT NULL," +
            "CHECK (AVALIACAO_DO_CURSO_PELO_EGRESSO.MELHORIA_CAPACIDADE_COMUNICACAO >= 0 AND AVALIACAO_DO_CURSO_PELO_EGRESSO.MELHORIA_CAPACIDADE_COMUNICACAO <=10)," +
            "CAPACIDADE_ETICA_RESPONSABILIADE INTEGER NOT NULL," +
            "CHECK (AVALIACAO_DO_CURSO_PELO_EGRESSO.CAPACIDADE_ETICA_RESPONSABILIADE >= 0 AND AVALIACAO_DO_CURSO_PELO_EGRESSO.CAPACIDADE_ETICA_RESPONSABILIADE <=10)," +
            "CAPACIDADE_HABILIDADES_AREA_CONHECIMENTO INTEGER NOT NULL," +
            "CHECK (AVALIACAO_DO_CURSO_PELO_EGRESSO.CAPACIDADE_HABILIDADES_AREA_CONHECIMENTO >= 0 AND AVALIACAO_DO_CURSO_PELO_EGRESSO.CAPACIDADE_HABILIDADES_AREA_CONHECIMENTO <=10)," +
            "COMENTARIO VARCHAR(300)," +
            "CHECK (AVALIACAO_DO_CURSO_PELO_EGRESSO.HISTORICO >= 0));";
    ...
    @Test(expected = SQLIntegrityConstraintViolationException.class)
    public void testaArmazenaAreaDeConhecimentoNomeVazio() throws SQLException{
        String sql = "INSERT INTO AREA_DE_CONHECIMENTO VALUES ('',05,01);";
        stmt.executeUpdate(sql);
...
////////////////////////////////////////// HISTORICO_NA_UFG ///////////////////////////////////////////////////////
    ...
    public void testaArmazenaAvaliacaoDoCursoPeloEgressoHistoricoNulo() throws SQLException{
        String sql = "INSERT INTO AVALIACAO_DO_CURSO_PELO_EGRESSO VALUES ();";
        stmt.executeUpdate(sql);
    }
    ...
    public void resetaBanco() {
        String sql1 = "SELECT concat('DROP TABLE IF EXISTS ', TABLE_NAME, ';') FROM information_schema.TABLES";
        String sql2 = "SET foreign_key_checks=off;";
