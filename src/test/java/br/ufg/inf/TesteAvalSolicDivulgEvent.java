...
public class TesteAvalSolicDivulgEvent {
	...
	public void encaminharSolicitacaoNaoAprovadaParaDivulgacao(){
		...
		Assert.assertEquals("Solicita��o com status de reprovada n�o pode ser divulgada", resposta);
	}
	...
	public void encaminharSolicitacaoParaDilvulgacao(){
		...
		Assert.assertEquals("Solicita��o em processo de divulgacao", resposta);
