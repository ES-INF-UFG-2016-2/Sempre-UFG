...
//
//public class ConsultaServicoMock implements ConsultaServicoInterface {
//    private Date ultimaConsulta;
//
//    public LinkedHashMap<String, String> executaConsultaDeEgressosPredefinida(int identificador, String consulta) throws ErroNaConsultaException {
//
