<<<<<<< HEAD:src/test/java/br/ufg/inf/servico/ExecConsTest.java
...
public class ExecConsTest {
    ...
    private CursoUFG criaCurso(String nomeCurso) {
        CursoUFG cursoUFG = new CursoUFG(null, null, 1, true, Turno.INTEGRAL, null,null);
...
>>>>>>> origin/develop:src/test/java/br/ufg/inf/sempreufg/servico/ExecConsTest.java
