...
//
//import br.ufg.inf.interfaces.ConsultaServicoInterface;
...
//import br.ufg.inf.servico.ConsultaServico;
...
//
//    private ConsultaServicoInterface consultaServico = new ConsultaServico();
//
...
//        resultadoObtido = consultaServico.executaConsultaDeEgressosPredefinida(identificador, null);
//
//        Assert.assertEquals(resultadoEsperado.toString(), resultadoObtido.toString());
//        Assert.assertEquals(((ConsultaEgressoMock) consultaServico).getUltimaConsulta().toString(), (new Date()).toString());
//
//    }
//
//    @Test
...
//
//        resultadoObtido = consultaServico.executaConsultaDeEgressosPredefinida(identificador, parametros);
//        Assert.assertEquals(resultadoEsperado.toString(), resultadoObtido.toString());
//        Assert.assertEquals(((ConsultaEgressoMock) consultaServico).getUltimaConsulta().toString(), (new Date()).toString());
//    }
//
...
//        int identificador = 3;
//        consultaServico.executaConsultaDeEgressosPredefinida(identificador, null);
//    }
//
...
//
//        consultaServico.executaConsultaDeEgressosPredefinida(identificador, parametros);
//    }
//
//
//    @Test
...
//
//        LinkedHashMap<String, String> resultadoObtido;
//        resultadoObtido = consultaServico.executaConsultaDeEgressosAdHoc(colunasABuscar, null);
//
//        Assert.assertEquals(resultadoEsperado.toString(), resultadoObtido.toString());
//
//    }
...
//
//        LinkedHashMap<String, String> resultadoObtido;
//        resultadoObtido = consultaServico.executaConsultaDeEgressosAdHoc(colunasABuscar, parametros);
//
//        Assert.assertEquals(resultadoEsperado.toString(), resultadoObtido.toString());
//    }
//
...
//        preencheColunasABuscarDaConsultaHadHoc(colunasABuscar);
//
//        consultaServico.executaConsultaDeEgressosAdHoc(colunasABuscar, null);
//    }
//
//    @Test(expected = ParametrosErradosException.class)
...
//        parametros.put("SEXO", "1990");
//
//        consultaServico.executaConsultaDeEgressosAdHoc(colunasABuscar, parametros);
//    }
//
//
