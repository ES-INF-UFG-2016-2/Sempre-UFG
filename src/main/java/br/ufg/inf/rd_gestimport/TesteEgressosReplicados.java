...
public class TesteEgressosReplicados extends Teste {

    public TesteEgressosReplicados(Connection conexaoDb, RdGestImport rd) {
        super(conexaoDb, rd);
    }

    public void efetuarTestes() {
        System.out.println(String.format("Testando coluna %s...", rd.getColunaQtdReplicados()));
        apagarTabela();
    ...
    public String getNomeColuna() {
        return rd.getColunaQtdReplicados();
    }
    ...
    private boolean testeDeInsercaoIncorreta() {
        try {
            ...
            preparedStatement.setInt(5, 10);
            preparedStatement.setInt(6, 10);
            preparedStatement.setString(7, "INCORRETO");
            preparedStatement.setInt(8, 10);
            preparedStatement.setInt(9, 10);
            return preparedStatement.executeUpdate() == 0;
        } catch (SQLException e) {
