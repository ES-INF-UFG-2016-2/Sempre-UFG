...
public class Usuario {
	...
	private Date ultimoEventoRecebido;

	public Date getUltimoEventoRecebido() {
		return ultimoEventoRecebido;
	}

	public void setUltimoEventoRecebido(Date ultimoEventoRecebido) {
		this.ultimoEventoRecebido = ultimoEventoRecebido;
	}
