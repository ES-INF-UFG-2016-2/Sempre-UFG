...
public class TesteFimPeriodo extends Teste {

    public TesteFimPeriodo(Connection conexaoDb, RdGestImport rd) {
        super(conexaoDb, rd);
    }

    public void efetuarTestes() {
        System.out.println(String.format("Testando coluna %s...", rd.getColunaFimPeriodo()));
        apagarTabela();
