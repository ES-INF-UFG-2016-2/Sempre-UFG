            ...
            <div class="col-lg-offset-1 col-lg-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form">
                            <fieldset id="graduation">
                                <div class="row">
                                    <div class="col-lg-offset-1 col-lg-9">
                                        <div class="form-group">
                                            <label for="institution">Instituição</label>
                                            <input class="form-control" id="institution" type="text" maxlength="150" placeholder="Colégio Estadual Exemplo">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select id="institution_type" class="form-control">
                                                ...
                                                <option>Paticular</option>
                                                <option>Militar</option>
                                                <option>Outro</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Período Cursando</label>
                                            <div class="row">
                                                <div class="col-lg-2">
